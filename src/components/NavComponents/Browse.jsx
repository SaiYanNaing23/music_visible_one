...
const Browse = () => {
  return (
    <div className='mt-[10%] text-[#4a4a4a] ' >
        <h1 className='text-lg text-[#4a4a4a]/50 font-bold ' >BROWSE</h1>
        <ul>
            <li className='flex gap-5 items-center mt-[8%] cursor-pointer ' >
                <img src="/home.svg" alt="home" />
                <p className='font-extrabold text-xl ' >Home</p>
            </li>
            <li className='flex gap-5 items-center mt-[8%] hover:font-extrabold cursor-pointer ' >
